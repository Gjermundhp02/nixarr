      ...
      script = let
        natpmpScript = pkgs.writeShellApplication {
          ...
          text = ''
            ...
            renew_port() {
              protocol="$1"
              port_file="${cfg.stateDir}/natpmp/$protocol-port"
              ...
              then
                ...
                ${cfg.transmission.package}/bin/transmission-remote http://192.168.15.1:${toString cfg.transmission.uiPort}/transmission/rpc/ --port "$new_port"
              fi
